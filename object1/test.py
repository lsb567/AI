...
first = Adj[1][3] + Adj[3][10] + Adj[10][14] + Adj[14][20] + Adj[20][24] + Adj[24][29] + Adj[29][32] + Adj[32][34]
second = Adj[1][3] + Adj[3][10] + Adj[10][14] + Adj[14][18] + Adj[18][28] + Adj[28][30] + Adj[30][32] + Adj[32][34]
print(first, second)
